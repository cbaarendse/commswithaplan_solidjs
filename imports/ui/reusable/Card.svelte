...
<article class="card" style:background-color={card.backgroundColor} style:font-color={card.color}>
  {#if card.imgFiles}
  ...
  <div class="card__footer" style:background-color={card.backgroundColor} style:font-color={card.color}>
    <p>
