// interfaces
import {Content, Color, Actionable, Chapter} from '../../both/typings/types';

// variables
const toolsHomeItemsData: (Actionable & Color)[] = [
  {
    name: 'tools',
    color: 'green',
    link: '/tools/reach',
...
export const toolsHomeItems = () => toolsHomeItemsData;

const definitionsData: Content[] = [
  {
    name: 'total_reach',
    definitions: [
      {
...
export const definitions = () => definitionsData;
...
export const documentation = () => documentationData;
