...
function  PlanProvider() {
    ...
    let _totalNetReach = 0.0;
    let _locus = 0.0;
    const _touchPointNames = [
      'advocacy',
      'ambassador',
      'app',
      'asset',
    ...
    // Public properties
    this.showAll = true;
 this.sortingTouchPoints = true; // False means the sorting is done by reach

  
  // Setting up a new plan, with all reach values at zero.
    
   let _touchPoints = _touchPointNames.map((touchPoint) =>{return touchPoint.input=0.0});
