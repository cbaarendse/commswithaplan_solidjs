  ...
  export function assembleMonths(start, end) {
      const months = [];
  ...
  export function assembleWeeks(start, end) {
      const weeks = [];
  ...
  export function calculatePreambleDays(start) {
      const dayOne = dayjs(start).startOf('month');
  ...
  export function mayChange(touchPointName, userId) {
      // This check happens just for the ui, real authorisation check happens in validated methods.
      if (
          Roles.userIsInRole(userId, ['owner', 'companyAdmin', touchPointName], useSession('companyId')) ||
  ...
  export function maySeeDatesForCompany(id) {
  ...
  export function maySeeInputForCompany(id) {
      // Client based check for more relevant presentation
  ...
  export function maySeeCostsForCompany(id) {
      // Client based check for more relevant presentation
  ...
  export function mayChangeTouchPointForCompany(tp, id) {
      // Client based check for more relevant presentation
  ...
  // general functions
  export function defaultInputType(touchPointName) {
      if (
